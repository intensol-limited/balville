...
ActiveRecord::Schema.define(:version => 20111109135131) do
  ...
  add_index "newsblogs", ["id"], :name => "index_newsblogs_on_id"
...
# Could not dump table "vacancies" because of following StandardError
#   Unknown type 'image' for column 'titleimg'
